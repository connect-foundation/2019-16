...
const { searchStudyGroup, searchStudyGroupWithCategory, tagStudyGroup, searchAllStudyGroup, searchAllStudyGroupWithCategory, bulkStudyGroups } = require("../elasticsearch");
